                            ...
                            if (isset($_POST['gender'])) {
                                ...
                                animation:button .3s linear;text-align: center;">
                                        ...
                                        header("refresh:2;"); ?>
                                            ...
                                            $query = "SELECT DISTINCT(A.STUD_ID),B.FIRSTNAME,B.MIDDLENAME,B.LASTNAME FROM STUDENT A JOIN STUDENT_PERSONAL B ON(A.STUD_ID=B.STUD_ID) JOIN CLASS_STUDENT C ON (A.STUD_ID=C.STUD_ID) WHERE C.SUB_CODE = $s_code  ORDER  BY  B.FIRSTNAME";
                                            // Prepare and execute the query
                                            $statement = oci_parse($conn, $query);
                                            oci_execute($statement);
                                            $spreadsheet = new Spreadsheet();
