...
<body>
  ...
  <div class="wrapper">
    ...
    <form action="grade.php" method="post" style="min-height: 250px;">
      ...
      <div class="input-box">
        <input name="gr_inter" placeholder="Enter Letter Grade Interpretation" pattern="[A-z]+" required>
      </div>
      ...
      <div class="message">
        ...
        if (isset($_POST['change'])) {
          ...
          $gr_in = strtoupper($_POST['gr_inter']);
          if ($grade != '') {
            if ($gr_in != '') {
        ...
        ?><div style="font-size:15px;
                  ...
                  position: relative;
                   display:flex;
                  animation:button .3s linear;text-align: center;">
                  <?php echo "GRADE ALREADY ENTERED";
                        header("refresh:2;"); ?>
                </div> <?php
                      }
                    } else {
                ...
                position: relative;
                 display:flex;
                animation:button .3s linear;text-align: center;">
                <?php echo "ENTER GRADE INTERPRETATION";
                      header("refresh:2;"); ?>
              </div> <?php
                    }
                  } else {
